...
public class VrpXMLWriterMapotempo {
    ...
    private Logger log = LogManager.getLogger(VrpXMLWriterMapotempo.class);

    private VehicleRoutingProblem vrp;

    private Collection<VehicleRoutingProblemSolution> solutions;

    public VrpXMLWriterMapotempo(VehicleRoutingProblem vrp, Collection<VehicleRoutingProblemSolution> solutions) {
        this.vrp = vrp;
        this.solutions = solutions;
    }

    public VrpXMLWriterMapotempo(VehicleRoutingProblem vrp) {
        this.vrp = vrp;
        this.solutions = null;
    }

    private static Logger logger = LogManager.getLogger(VrpXMLWriterMapotempo.class);
